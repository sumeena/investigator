                    ...
                    <form method="post" action="/admin/hr/submit">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                                   ...
                                   value="{{isset($hr) && !empty($hr->first_name) ? $hr->first_name:'' }}">
                            @error('first_name')
                    ...
                    <strong>{{ $message }}</strong>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                   ...
                                   value="{{isset($hr) && !empty($hr->last_name) ? $hr->last_name:'' }}">
                            @error('last_name')
                            <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="text" class="form-control @error('email') is-invalid @enderror"
                                       name="email" value="{{isset($hr) && !empty($hr->email) ? $hr->email:''}}">
                            </div>
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                        ...
                        <button type="submit"
                                class="btn btn-primary">{{isset($hr) && !empty($hr->id) ? 'Update':'Submit'}}</button>
                    </form>
                </div>
            </div>
        </div>
