    ...
    <div class="col-md-10">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.company-admins.index') }}" class="float-end">
                    Back
                </a>
            </div>
            <div class="card-body">
                <form method="post" action="{{ route('admin.company-admins.submit') }}">
                    ...
                    <div class="mb-2">
                        ...
                        <label class="form-label" for="basic-default-message">Company Name</label>
                        <input type="text" name="company_name_edit" class="form-control mb-3" value="{{ $companyAdminProfile[0]?->company_name }}">
                    ...
                    <div class="mb-3 {{ isset($companyAdmin) && !empty($companyAdmin->id) ? 'd-none' : '' }}" id="newCompanyLink">
                        ...
                        <label class="mb-3 form-label" for="basic-default-message">Company Link</label>
                        <div class="row">
                            <div class="col-md-2">
