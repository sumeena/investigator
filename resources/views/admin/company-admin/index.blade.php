                ...
                <tbody>
                    @foreach ($companyAdmins as $key => $value)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.company-admins.edit', $value->id) }}">Edit</a> | <a onclick="return confirm('Are you sure want to delete?')" href="{{ route('admin.company-admins.delete', $value->id) }}">Delete</a>
