...
@section('title', "Notification for Hiring Manager")
@section('content')
    <div class="row mt-4 mb-4 mx-0 justify-content-center">
        <div class="col-md-10">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Notification for Hiring Manager</h5>
                </div>
                <div class="card-body">
                    @if(session('success'))
                    ...
                    @endif
                    <form method="post" action="{{ route('hm.settings.store') }}" enctype="multipart/form-data">
                        @csrf
                        <hr>
