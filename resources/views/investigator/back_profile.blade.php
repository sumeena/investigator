                                ...
                                <div class="table-responsive text-nowrap">
                                    <table class="table languages">
                                        ...
                                        <tr class="text-nowrap">
                                            ...
                                            <th>Spoken Fluency Level</th>
                                            <th>Reading/Writing Fluency Level</th>
                                            <th>Action</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @php
                                            ...
                                            $languageOldData = $languages->count() ? $languages->toArray() : $workVehicleOldData;
                                            $oldWorkVehicleData = old('languages', $languageOldData);
                                        @endphp
                                        @if(count($oldWorkVehicleData))
                                            @foreach($oldWorkVehicleData as $languageKey => $language)
                                                <tr>
                                                    <td>
                                                        <select id="defaultSelect"
                                                                class="form-select @error('languages.'.$languageKey.'.language') is-invalid @enderror"
