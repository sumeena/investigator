...
@section('content')
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="text" name="assignment_id"
                                                               class="form-control assignment-id" id="assignment-id"
                                                               placeholder="Enter assignment ID" readonly required>
                                                        <span role="alert" class="text-danger small d-none"
                                                              id="assignment-id-error"> Assignment ID is required! </span>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="table-responsive text-nowrap">
                                                <table class="table hr_contact">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="form-control caseLocationField"
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control caseDistanceField"
                                                                   name="distance" placeholder="Distance (IN MILES)"
                                                                   value="{{ old('distance', $request->get('distance')) }}"
                                                                   id="distance">
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input class="form-check-input" type="checkbox"
                                                                   id="surveillance" value="surveillance"
                                                                   name="surveillance" @checked(old('surveillance', $request->get('surveillance')) == 'surveillance')>
                                                            <label>Surveillance</label>
                                                        </td>
                                                        <td>
                                                            <input class="form-check-input" type="checkbox"
                                                                   id="statements" value="statements"
                                                                   name="statements" @checked(old('statements', $request->get('statements')) == 'statements')>
                                                            <label>Statements</label>
                                                        </td>
                                                        <td>
                                                            <input class="form-check-input" type="checkbox" value="misc"
                                                                   name="misc"
                                                                   id="misc" @checked(old('misc', $request->get('misc')) == 'misc')>
                                                            <label>Misc</label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select class="form-select" name="license"
                                                                ...
                                                                @foreach($states as $state)
                                                                    <option
                                                                        value="{{ $state->id }}" @selected(old('license', $request->get('license')) == $state->id)>
                                                                        {{ $state->code }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <td>
                                                        <select id="language-select" class="form-control form-select"
                                                            ...
                                                            @foreach($languageOptions as $languageOption)
                                                                <option
                                                                    value="{{ $languageOption['id'] }}" @selected(old('languages', $request->get('languages')) && in_array($languageOption['id'], old('languages', $request->get('languages'))))>
                                                                    {{ $languageOption['name'] }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                    ...
                                    <div class="mb-1">
                                        <div class="card">
                                            <div class="table-responsive">
                                                ...
                                                <button type="button" class="btn btn-primary hr_investigator_search"
                                                        id="callCreateAssignmentModal">
                                                    Search
                                                </button>
                                ...
                                @forelse($investigators as $investigator)
                                    ...
                                    $investigator->calculated_distance)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="btn btn-info btn-sm inviteSendBtn"
                ...
                <form id="assignmentCreateForm">
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="assignment_id" class="form-control assignment-id"
                                   id="assignment-id" placeholder="Enter assignment ID" readonly required>
                        </div>
    ...
    <div class="modal fade" id="confirmUpdateSearchModal" tabindex="-1" aria-labelledby="confirmUpdateSearchModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"
                            id="confirmUpdateSearchModalCloseBtn">
                        NO
                    </button>
                </div>
            </div>
