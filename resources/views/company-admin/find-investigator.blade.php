...
@section('content')
            ...
            <div class="col-md-12">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-search-tab" data-toggle="pill"
                                data-target="#pills-search" type="button" role="tab" aria-controls="pills-search"
                                aria-selected="true">
                            Search
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-assignment-tab" data-toggle="pill"
                                data-target="#pills-assignment"
                                type="button" role="tab" aria-controls="pills-assignment" aria-selected="false">
                            Assignments
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="createAssignmentBtn"
                                type="button">
                            Create Assignment
                        </button>
                    </li>
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-search" role="tabpanel"
                        ...
                        <div class="row mt-4 mb-4 mx-0">
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    <div
                                        class="card-header pt-2 pb-0 d-flex justify-content-between align-items-center">
                                             ...
                                             State is required!
                                                             ...
                                                             Zipcode is required!
                                                              ...
                                                              Lat and lng is not found for this zipcode, please try another zipcode!
                                                                            ...
                                                                            <span role="alert"
                                                                                  class="text-info small ms-1 d-none"
                                                    ...
                                                    <div class="mb-1">
                                                        <div class="card">
                                                            <div class="table-responsive">
                                                                <button type="submit"
                                                                        class="btn btn-primary hr_investigator_search"
                                                                        id="form-submit-btn">
                                                                    Search
                                                                </button>
                                                            </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <button type="button"
                                                                        ...
                                                                        data-assignment-count="{{ $assignments->count() }}"
                    ...
                    <div class="tab-pane fade" id="pills-assignment" role="tabpanel"
                ...
                <form id="assignmentCreateForm">
                    <div class="modal-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="assignment_id" class="form-control" id="assignment-id"
                                   placeholder="Enter assignment ID" readonly required>
                        </div>
                        <div class="form-group">
                            <label for="client-id">
                                Client ID
                            </label>
                            <input type="text" name="client_id" class="form-control" id="client-id"
    ...
    <div class="modal fade" id="noAssignmentCreateModal" tabindex="-1" aria-labelledby="noAssignmentCreateModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form id="noAssignmentCreateForm">
                    <div class="modal-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="assignment_id" class="form-control" id="no-assignment-id"
                                   placeholder="Enter assignment ID" readonly required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="client_id" class="form-control" id="no-client-id"
                                   placeholder="Enter client ID" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                ...
                <form id="assignmentEditForm">
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="assignment_id" class="form-control" id="edit-assignment-id"
                                   placeholder="Enter assignment ID" readonly required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="client_id" class="form-control" id="edit-client-id"
                                   placeholder="Enter client ID" required>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <div class="modal fade" id="noAssignmentModal" tabindex="-1" aria-labelledby="noAssignmentModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
