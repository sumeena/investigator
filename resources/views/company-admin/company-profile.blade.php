                    ...
                    <div class="row">
                        <div class="col">
                            <h5 class="">
                                ...
                                <a href="{{ route('company-admin.profile') }}" class="btn btn-outline-primary btn-sm text-white float-end mt-n1">
                    ...
                    <div class="row mx-0 py-1 px-3">
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">{{ $CompanyAdminProfile->timezone ? $CompanyAdminProfile->timezone->timezone . ' - [' . $CompanyAdminProfile->timezone->name . ']' : '' }}</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">{{ $user?->website ?? $user?->parentCompany?->company?->website }}</div>
                            </div>
                        </div>
                    </div>
                </div>
