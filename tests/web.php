...
Route::get('/accountadmin/orders', 'Accountadmin\OrderController@index')->middleware(['auth','admin']);
...
Route::any('other-checkout', 'FlowerBySubscriptionController@other_checkout');
...
Route::get('/vendor', 'HomeController@index')->name('dashboard.index')->middleware('vendor');
...
/*
Route::get('/accountadmin/location-types/back', 'Accountadmin\LocationTypeController@back')->middleware(['auth','admin']);
Route::get('/accountadmin/location-types','Accountadmin\LocationTypeController@index')->name('accountadmin.location-types.index')->middleware(['auth','admin']);
Route::get('/accountadmin/location-types/add','Accountadmin\LocationTypeController@create')->name('accountadmin.location-types.add')->middleware(['auth','admin']);
Route::post('/accountadmin/location-types/submit','Accountadmin\LocationTypeController@store')->name('accountadmin.location-types.store')->middleware(['auth','admin']);
Route::get('/accountadmin/location-types/edit/{id}','Accountadmin\LocationTypeController@edit')->name('accountadmin.location-types.edit')->middleware(['auth','admin']);
Route::post('/accountadmin/location-types/update','Accountadmin\LocationTypeController@store')->name('accountadmin.location-types.update')->middleware(['auth','admin']);
Route::get('/accountadmin/location-types/delete/{id}','Accountadmin\LocationTypeController@delete')->name('accountadmin.location-types.delete')->middleware(['auth','admin']);
*/
...
//Route::post('/account/user/submit', [App\Http\Controllers\Superadmin\AccountController::class, 'store'])->middleware(['auth','superadmin']);
